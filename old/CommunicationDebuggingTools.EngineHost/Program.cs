...
namespace CommunicationDebuggingTools.EngineHost {
    ...
    public static class Program {
        ...
        public static void Main (string[] args) {
            ...
            app.MapGet("/api/status", (IDeviceService devices, IVariableService variables, IProtocolResolver protocols) => Results.Ok(new {
                serverTime = DateTimeOffset.Now,
                processId = Environment.ProcessId,
                uptimeSeconds = (long)(DateTimeOffset.Now - ProcessStartTime).TotalSeconds,
                role = "master",   // EngineHost 是唯一主采集宿主
                ...
                protocolCount = protocols?.GetProtocolNames()?.Count ?? 0
            }));
