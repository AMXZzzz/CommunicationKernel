...
namespace CommunicationDebuggingTools.Scenarios {
    ...
    /// <summary>
    /// 场景服务：按变量名一键批量写入所有设备（模板示例，如“修改所有设备宽度”）。
    /// 属于上层可替换业务，仅依赖 Core 接口；具体项目可替换匹配规则。
    /// </summary>
    public sealed class BulkWriteService {
        ...
        /// <summary>
        /// 向所有设备中名称等于 <paramref name="variableName"/> 的变量写入同一个值。
        /// 逐台执行，单台失败不影响其余；返回每台设备的结果。
        /// </summary>
