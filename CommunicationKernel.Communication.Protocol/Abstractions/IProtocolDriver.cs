...
/// </para>
/// <list type="bullet">
///   <item>Modbus 寄存器区 → 向上取整到 16 位寄存器：quantity = (length + 1) / 2</item>
///   <item>Modbus 位区     → 每字节 8 位：quantity = length * 8</item>
///   <item>MEWTOCOL 字区   → 同样按 2 字节一个字换算</item>
///   <item>S7              → 本就按字节寻址，直接透传</item>
/// </list>
/// <para>
